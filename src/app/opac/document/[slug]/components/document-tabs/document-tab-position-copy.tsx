  ...
  return (
    <div className="flex flex-col gap-6">
      <Table className="w-full overflow-hidden rounded-md border border-gray-200">
        <TableHeader>
          <TableRow className="bg-gray-50">
            <TableHead className="px-4 py-2 text-left">VỊ TRÍ</TableHead>
            <TableHead className="px-4 py-2 text-left">KÝ HIỆU PHÂN LOẠI</TableHead>
            <TableHead className="px-4 py-2 text-left">TRẠNG THÁI</TableHead>
            <TableHead className="px-4 py-2 text-left">THAO TÁC</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
      ...
      <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-4 text-blue-800 shadow-sm">
        ...
        <div>
          <h4 className="mb-1 text-sm font-semibold">Thông tin vị trí</h4>
          <p className="text-sm leading-relaxed">
            Tài liệu này được đặt tại <strong>Kho sách tầng 2</strong>. Vui lòng liên hệ nhân viên
            thư viện nếu bạn cần hỗ trợ tìm tài liệu hoặc không tìm thấy tại vị trí này.
          </p>
        </div>
      </div>
    </div>
