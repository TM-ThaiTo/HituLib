...
const authors: Author[] = [
    { id: "1", name: "Nguyễn Văn A", affiliation: "Đại học Quốc gia Hà Nội", orcid: "0000-0001-2345-6789" },
    { id: "2", name: "Trần Thị B", affiliation: "Đại học Bách khoa Hà Nội", orcid: "0000-0002-3456-7890" },
    { id: "3", name: "Lê Văn C", affiliation: "Đại học Y Hà Nội", orcid: "0000-0003-4567-8901" },
    { id: "4", name: "Phạm Thị D", affiliation: "Đại học Kinh tế Quốc dân", orcid: "0000-0004-5678-9012" },
    { id: "5", name: "Hoàng Văn E", affiliation: "Đại học Sư phạm Hà Nội", orcid: "0000-0005-6789-0123" },
    { id: "6", name: "John Smith", affiliation: "Harvard University", orcid: "0000-0006-7890-1234" },
    { id: "7", name: "Maria Garcia", affiliation: "University of Oxford", orcid: "0000-0007-8901-2345" },
    { id: "8", name: "Zhang Wei", affiliation: "Peking University", orcid: "0000-0008-9012-3456" },
    { id: "9", name: "Tanaka Yuki", affiliation: "University of Tokyo", orcid: "0000-0009-0123-4567" },
    { id: "10", name: "Kim Min-ji", affiliation: "Seoul National University", orcid: "0000-0010-1234-5678" },
]
...
const documents: Document[] = [
    {
        ...
        abstract: "Giáo trình Toán cao cấp dành cho sinh viên năm nhất các ngành kỹ thuật và khoa học tự nhiên.",
    ...
    },
    {
        ...
        abstract: "This book presents the latest advances in machine learning algorithms and their applications.",
    ...
    },
    {
        ...
        abstract: "Luận án nghiên cứu các ứng dụng của trí tuệ nhân tạo trong chẩn đoán và điều trị bệnh.",
    ...
    },
    {
        ...
        abstract: "This article examines the effects of climate change on biodiversity in Southeast Asian ecosystems.",
    ...
    },
    {
        ...
        abstract: "An introduction to the principles of quantum computing and its potential applications.",
...
const collections: Collection[] = [
    ...
    },
    {
        ...
        description: "Collection of books and resources on computer science and information technology.",
        documentCount: 78,
        coverImage: "/abstract-mathematics.png",
        subjects: ["Computer Science", "Information Technology", "Programming", "Artificial Intelligence"],
        featured: true,
    },
    {
        id: "3",
...
const researchProjects: ResearchProject[] = [
    {
        ...
        abstract: "Nghiên cứu ứng dụng các thuật toán học máy để dự báo sự lây lan của dịch bệnh truyền nhiễm.",
    ...
    },
    {
        ...
        abstract: "account/research on developing quantum algorithms for solving complex optimization problems.",
    ...
    },
    {
        ...
        abstract: "Đánh giá tác động của biến đổi khí hậu đến đa dạng sinh học tại các hệ sinh thái ở Việt Nam.",
    ...
    },
    {
        ...
        abstract: "account/research on developing artificial intelligence tools for medical diagnosis and treatment planning.",
